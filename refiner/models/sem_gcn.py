...
from refiner.models.sem_graph_conv import SemGraphConv
from refiner.models.graph_non_local import GraphNonLocal
...
class SemGCN(nn.Module):
    def __init__(self, adj, hid_dim, coords_dim=(3, 3), num_layers=4, nodes_group=None, p_dropout=None):
